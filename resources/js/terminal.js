...
const CMD = {
  ...
  whoami: () => [
    ...
    '  CSE Graduate @ AUST · CGPA 3.772',
    '  Junior Software Engineer @ Dynamic Solutions Innovators (DSI)',
    '  Competitive Programmer · Technical Leader',
    '  Ex-President — AUST Programming and Informatics Club',
    '  Champion — Learnathon 3.0 · Top 7% ICPC Dhaka Regional',
  ],
  skills: () => [
    '<span class="t-ok">Tech Stack:</span>',
    '  <span class="kw">Languages</span>: C++, C, Python, Java, Dart, JS, C#',
    '  <span class="fn">Web/Mobile</span>: Flutter, HTML/CSS, ASP.NET MVC, Spring Boot, JavaFX, PHP',
    '  <span class="str">Databases</span>: MySQL, Supabase, SQL Server, Firebase',
    '  <span class="type">Tools</span>:     Linux, Shell, Perl, Docker, GitHub Actions, Judge0, OpenCV',
  ],
  contact: () => [
  ...
  neofetch: () => [
    ...
    '  <span style="color:var(--accent)">    ██████████████████████</span><span style="color:var(--a2)">Role</span>     Junior Software Engineer @ DSI',
    '  <span style="color:var(--accent)">   ██████████████████████</span> <span style="color:var(--a2)">Major</span>    CSE @ AUST',
    '  <span style="color:var(--accent)">   ██████████████████████</span> <span style="color:var(--a2)">CGPA</span>     3.772 / 4.00',
    '  <span style="color:var(--accent)">    ██████████████████████</span><span style="color:var(--a2)">ICPC</span>     Top 7% Dhaka Regional',
    '  <span style="color:var(--accent)">     ████████████████████</span> <span style="color:var(--a2)">Club</span>     Ex-President · AUST PIC',
